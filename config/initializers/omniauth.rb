...
ActionController::Dispatcher.middleware.use OmniAuth::Builder do
  provider(:facebook, omniauth_config['facebook']['app_id'], omniauth_config['facebook']['app_secret'], {:scope => omniauth_config['facebook']['scope']}) if omniauth_config['facebook'].present?
