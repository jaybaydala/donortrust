...
ActionController::Dispatcher.middleware.use OmniAuth::Builder do
  provider(:facebook, omniauth_config['facebook']['app_id'], omniauth_config['facebook']['app_secret'], {:scope => omniauth_config['facebook']['scope'], :client_options => {:ssl => {:ca_path => "/etc/ssl/certs"}}}) if omniauth_config['facebook'].present?
