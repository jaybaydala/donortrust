...
ActionController::Routing::Routes.draw do |map|
  ...
  map.auto_complete_for_place_name  'bus_admin/projects/auto_complete_for_place_name', :controller => 'bus_admin/projects', :action => 'auto_complete_for_place_name'
  map.update_location 'bus_admin/projects/update_location', :controller => 'bus_admin/projects', :action => 'update_location'
  map.update_partner 'bus_admin/projects/update_partner', :controller => 'bus_admin/projects', :action => 'update_partner'
  map.update_sectors 'bus_admin/projects/update_sectors', :controller => 'bus_admin/projects', :action => 'update_sectors'
  map.create_subagreement 'bus_admin/projects/create_subagreement', :controller => 'bus_admin/projects', :action => 'create_subagreement'
  map.delete_pending 'bus_admin/projects/delete_pending', :controller => 'bus_admin/projects', :action => 'delete_pending'
  map.project_auto_update 'bus_admin/projects/project_auto_update', :controller => 'bus_admin/projects', :action => 'auto_update'
