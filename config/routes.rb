ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :rank_types, :active_scaffold => true, :path_prefix => "/bus_admin", :controller => "bus_admin/rank_types"
    ...
    map.resources :projects, :controller => 'bus_admin/projects', :name_prefix => 'bus_admin_', :path_prefix => '/bus_admin', :collection => {:pending_projects => :get, :rejected_projects => :get }, :member => { :details => :get, :community => :get, :nation => :get, :organization => :get, :connect => :get, :cause => :get, :facebook_login => :get, :timeline => :get, :approve_project => :put, :reject_project => :put }
