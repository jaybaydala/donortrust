ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :project_you_tube_videos, :path_prefix => "/bus_admin",
    ...
    :collection => { :add => :post, :remove => :post, :search => :post, :projects => :post, :videos => :post, :preview => :post, :search_by_tag => :post, :search_by_user => :post, :search_by_category_and_tag => :post, :list_by_featured => :post, :list_by_popular => :post, :show_video => :post, :show_search => :get, :update_table => :post, :row => :get }
  ...
  map.resources :project_flickr_images, :path_prefix => "/bus_admin",
    ...
    :collection => { :add => :post, :remove => :post, :search => :post, :projects => :post, :show_flickr => :post, :show_db_flickr => :post, :photos=>:post, :show_search => :get, :update_table => :post, :row => :get }
