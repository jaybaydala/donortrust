...
ActionController::Routing::Routes.draw do |map|
  ...
  map.namespace(:dt) do |dt|
    ...
    dt.resources :projects, :member => { :details => :get, :community => :get, :nation => :get, :organization => :get, :connect => :get, :cause => :get, :facebook_login => :get, :timeline => :get }, :collection => {:search => :get, :add_countries => :get}
