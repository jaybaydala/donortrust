...
class BusAdmin::ECardTest < Test::Unit::TestCase
  fixtures :e_cards
...
#    end
    ...
    def create_e_card(options = {})
      ECard.create({ :name => 'Test Name', :credit => 'test', :file => uploaded_file(file_path("test.jpg"), "image/jpeg", "test") }.merge(options))  
    end    
