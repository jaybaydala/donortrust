class BusAdmin::ContactsController < ApplicationController
  ...
  active_scaffold :contact do |config|
    ...
    config.list.columns = [:first_name, :last_name, :phone_number, :email_address, :partner]
    config.update.columns = [:first_name, :last_name, :phone_number, :fax_number, :email_address, :web_address, :department, :place, :address_line_1, :address_line_2, :postal_code, :partner]
    #config.nested.columns = [:first_name, :last_name, :phone_number]
    config.create.columns = [:first_name, :last_name, :phone_number, :fax_number, :email_address, :web_address, :department, :place, :address_line_1, :address_line_2, :postal_code, :partner]
