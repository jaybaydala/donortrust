module GiftTestHelper
  ...
  def create_gift(options = {})
    ...
    Gift.create({ :amount => 1, :to_name => 'To Name', :to_email => 'to@example.com', :to_email_confirmation => 'to@example.com', :name => 'From Name', :email => 'from@example.com', :email_confirmation => 'from@example.com', :message => 'hello world!' }.merge(options))
  end
end
